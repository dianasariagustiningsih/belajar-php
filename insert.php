...
$sql = "insert into mahasiswa (id_jurusan, nim, nama, jenis kelamin, tempat lahir, tanggal lahir, alamat)
    values ($id_jurusan, '$nim', '$nama', '$gender', '$tpt_lahir', 'Stgl_lahir', 'Salamat')";
